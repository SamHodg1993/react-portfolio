  ...
  return (
    <div className='about-container' id="about">
        ...
        <div className='about-details'>
            <h3 className='about-details-item title'>Hi, I'm Sam, a tech enthusiast. My career in devlopment started as just a hobby...</h3>
            <p className='about-details-item details'>For the past 10 years I have led an interesting life, starting out as an Infantryman in 
                ...
                you hear, dont be a stranger, get in <button onClick={() => scrollToContact()}>touch...</button>
            </p>
        </div>
    </div>
  )
